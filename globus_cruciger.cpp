...
void ataqueComum()
{
    ...
    Texture2D ataqueComum = LoadTexture("./SpritesT/cortezinho.png");
...
void ataqueComum2()
{
    const int screenWidth = 1000;
    const int screenHeight = 740; 
    Texture2D ataqueComum = LoadTexture("./SpritesT/AtaqueComum.png");
    float x = screenWidth/2 - 100, y = (screenHeight / 2) -100  ;
...
void chuvaDeRaios(){
    ...
    const int screenWidth = 1000;
    const int screenHeight = 740;
    Texture2D chuvaDeRaios = LoadTexture("./SpritesT/raio.png");
    float x = screenWidth/2 - 100, y = (screenHeight / 2) -100  ; 
...
void espada(){
    ...
    const int  screenWidth = 1000;
    const int screenHeight = 740;
    Texture2D espadaEncantada = LoadTexture("./SpritesT/espada.png");
...
void golpePerfurante()
{
    const int screenWidth = 1000;
    const int screenHeight = 740;
    Texture2D golpePerfurante = LoadTexture("./SpritesT/perfurante.png");
    float x = screenWidth/2 - 100, y = (screenHeight / 2) -100  ;
...
void raioDeGelo()
{
    ...
    Texture2D raioDeGelo = LoadTexture("./SpritesT/gelinho.png");
...
void bolaDeFogo()
{
    const int screenWidth = 1000;
    const int screenHeight = 740;
    Texture2D bolaDeFogo = LoadTexture("./SpritesT/boladefogo.png");
    float x = screenWidth/2 - 100, y = (screenHeight / 2) -100  ;
...
int main(void)
{
    ...
    const int screenHeight = 740;
     ...
     InitWindow(screenWidth, screenHeight, "globus cruciger");
...
//////////////------Texturas para todos os elementos do mapa------//////////////////////////////////////
    ...
    Texture2D knightUp = LoadTexture("./SpritesT/Sprites_mapa_mov/knightup.png");
    Texture2D knightDown = LoadTexture ("./SpritesT/Sprites_mapa_mov/knightdown.png");
    Texture2D knightRight = LoadTexture("./SpritesT/Sprites_mapa_mov/knightright.png");
    Texture2D knightLeft = LoadTexture("./SpritesT/Sprites_mapa_mov/knightleft.png");
    Texture2D walk = LoadTexture("./SpritesT/Sprites_mapa_mov/tile_walk.png");
    Texture2D grama = LoadTexture("./SpritesT/Sprites_mapa_mov/grama.png");
    Texture2D casa1 = LoadTexture("./SpritesT/Sprites_mapa_mov/frente1.png");
    Texture2D casa2 = LoadTexture("./SpritesT/Sprites_mapa_mov/Casa2.png");
    Texture2D casa3 = LoadTexture("./SpritesT/Sprites_mapa_mov/Casa3.png");
    Texture2D casa4 = LoadTexture("./SpritesT/Sprites_mapa_mov/Casa4.png");
    Texture2D casa5 = LoadTexture("./SpritesT/Sprites_mapa_mov/Casa5.png");
    Texture2D casa6 = LoadTexture("./SpritesT/Sprites_mapa_mov/casa6.png");
    Texture2D arvore = LoadTexture("./SpritesT/Sprites_mapa_mov/arvore.png");
    Texture2D well = LoadTexture("./SpritesT/Sprites_mapa_mov/well.png");
    Texture2D statue = LoadTexture("./SpritesT/Sprites_mapa_mov/statue.png");
    Texture2D bush = LoadTexture("./SpritesT/Sprites_mapa_mov/bush.png");
    Texture2D bush1 = LoadTexture("./SpritesT/Sprites_mapa_mov/bush1.png");
    Texture2D sand = LoadTexture("./SpritesT/Sprites_mapa_mov/sand.png");
    Texture2D graves = LoadTexture("./SpritesT/Sprites_mapa_mov/graves.png");
    Texture2D flores = LoadTexture("./SpritesT/Sprites_mapa_mov/flowers.png");
    Texture2D light = LoadTexture("./SpritesT/Sprites_mapa_mov/light.png");
    Texture2D gate = LoadTexture("./SpritesT/Sprites_mapa_mov/gate.png");
    Texture2D fence = LoadTexture("./SpritesT/Sprites_mapa_mov/fence.png");
    Texture2D wall = LoadTexture("./SpritesT/Sprites_mapa_mov/wall.png");
    ...
    */
    ...
    Texture2D Castelo = LoadTexture("./SpritesT/Background/Castelo(Rei).png");
    Texture2D Realeza = LoadTexture("./SpritesT/realeza.png");
    Texture2D hud = LoadTexture("./SpritesT/Hud_Aliados.png");
    Texture2D aventureiros = LoadTexture("./SpritesT/Main_Characters.png");
    Texture2D descricao = LoadTexture("./SpritesT/descricao.png");
    
    Texture2D mensageiro = LoadTexture("./SpritesT/mensageiroLeft.png");
    Texture2D mensageiroR = LoadTexture("./SpritesT/mensageiroRight.png");
    
    
    //////////////////////////////////-----Floresta-----//////////////////////////////////////////////////////////
    
    Texture2D gramaf = LoadTexture("./SpritesT/Sprites_mapa_mov/grama.png");
    Texture2D trevas = LoadTexture("./SpritesT/piso.png");
    Texture2D lamiap = LoadTexture("./SpritesT/Inimigos/Floresta/Lamia_Sprites.png");
    Texture2D slimet = LoadTexture("./SpritesT/Inimigos/Floresta/Slime_Spritest.png");
    //Texture2D slime = LoadTexture("C:/Users/Maike Menezes/Documents/MAIKE/Programming/RPG/Map/extra/slime.png");
    Texture2D ogro = LoadTexture("./SpritesT/Inimigos/Floresta/Ogro_Sprites.png");
    Texture2D wolf = LoadTexture("./SpritesT/Inimigos/Floresta/Wolf_Sprites.png");
    Texture2D pedra =  LoadTexture("./SpritesT/Pedras.png");
    Texture2D tora = LoadTexture("./SpritesT/seca.png");
    //Texture2D bau = LoadTexture("C:/Users/Maike Menezes/Documents/MAIKE/Programming/RPG/Map/extra/Bau1.png");
   // Texture2D bau1 = LoadTexture("C:/Users/Maike Menezes/Documents/MAIKE/Programming/RPG/Map/extra/Bau2.png");
    Texture2D arvoree = LoadTexture("./SpritesT/arvoret.png");
    
    ///////////////////////////////////////////////-----Castelo-----///////////////////////////////////////////////
    
    Texture2D pisoC = LoadTexture("./SpritesT/pisoC.png");
    Texture2D agua = LoadTexture("./SpritesT/agua.png");
    Texture2D barra = LoadTexture("./SpritesT/barra.png");
    Texture2D barra2 = LoadTexture("./SpritesT/barra2.png");
    Texture2D pilastra = LoadTexture("./SpritesT/teste3.png");
    Texture2D caixao = LoadTexture("./SpritesT/caixao.png");
    Texture2D demonio = LoadTexture("./SpritesT/demonio.png");
    Texture2D hunter = LoadTexture("./SpritesT/Inimigos/Castelo/Drow_Hunter_Sprites.png");
    Texture2D thief = LoadTexture("./SpritesT/Inimigos/Castelo/Drow_Thief_Sprites.png");
    Texture2D warrior = LoadTexture("./SpritesT/Inimigos/Castelo/Drow_Warrior_Sprites.png");
    Texture2D warlock = LoadTexture("./SpritesT/Inimigos/Castelo/Undead_Warlock_Sprites.png");
    Texture2D guerreiro = LoadTexture("./SpritesT/Inimigos/Castelo/Full_Plate_Undead_Sprites.png");
    
    //////////////////////////////////////////////-----Combate-----///////////////////////////////////////////////
    
       
    Texture2D floresta = LoadTexture("./SpritesT/Background/floresta.png");
    Texture2D Saida_Cidade = LoadTexture("./SpritesT/Background/foradacidade.png");
    Texture2D Castelo_mago = LoadTexture("./SpritesT/Background/castelomago.png");
    Texture2D Batalha_final = LoadTexture("./SpritesT/Background/batalhafinal.png");  
    Texture2D Slime = LoadTexture("./SpritesT/Inimigos/Floresta/slimeG.png");
    Texture2D Wolf = LoadTexture("./SpritesT/Inimigos/Floresta/wolfG.png");
    Texture2D Ogro = LoadTexture("./SpritesT/Inimigos/Floresta/ogroG.png");
    Texture2D SlimeToxic = LoadTexture("./SpritesT/Inimigos/Floresta/slimetG.png");
    Texture2D Lamia = LoadTexture("./SpritesT/Inimigos/Floresta/lamiaG.png");
    Texture2D Drow_Hunter = LoadTexture("./SpritesT/Inimigos/Castelo/hunterG.png");
    Texture2D Drow_Thief = LoadTexture("./SpritesT/Inimigos/Castelo/thiefG.png");
    Texture2D Drow_Warrior = LoadTexture("./SpritesT/Inimigos/Castelo/warriorG.png");
    Texture2D Full_Plate_Undead = LoadTexture("./SpritesT/Inimigos/Castelo/undeadG.png");
    Texture2D Undead_Warlock = LoadTexture("./SpritesT/Inimigos/Castelo/warlockG.png");
    Texture2D Red_Mage = LoadTexture("./SpritesT/Inimigos/Castelo/redmageG.png");
    ...
    Texture2D texture[4];
    texture[0] = LoadTexture("./SpritesT/intro.png");
    texture[2] = LoadTexture("./SpritesT/orbe.png");
   

    InitAudioDevice();           
    Sound music = LoadSound("./SpritesT/intro.ogg");
    Vector2 position;
